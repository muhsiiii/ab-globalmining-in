...
<section class="welcome container-main">
  ...
  <div class="row">
    ...
    <h2 style="font-size: 27px;"> WELCOME TO OUR ABGM - INDIA WEBSITE!</h2>
        ...
        <div class="container-main">
          <div class="row">
            <div class="col-lg-6 contact-div">
              <h5>Physical Address (India Office)</h5>
              <ul>
                <li><i class="ri-map-pin-2-line"></i>  Office No A-435, Fourth Floor, Block A, <br> Tower A-2, World Trade Park, Jawaharlal Nehru <br> Marg, D-Block, Malviyar  Nagar,Jaipur, Rajasthan 302017, India</li>
              </ul>
            </div>
            <div class="col-lg-6 contact-div">
              <h5>Contact Details (India Office)</h5>
              <ul>
                <li><a href="tel:+91 1414047208"><i style="vertical-align: bottom;" class="ri-smartphone-line"></i>  +91 1414047208</a></li>
                <li><a href="#"><i style="vertical-align: bottom;" class="ri-mail-line"></i> info@abglobalmining.co.in</a></li>
              </ul>
            </div>
          </div>
        </div>
