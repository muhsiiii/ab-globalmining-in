<div class="contact-navbar">
  <div class="contact-nav">
    <a href="tel:+91 1414047208"><i style="vertical-align: bottom;" class="ri-phone-line"></i> Call : +91 1414047208</a>
  </div>
  <div class="contact-nav">
    <a href="#"><i style="vertical-align: bottom;" class="ri-mail-line"></i> info@abglobalmining.co.in</a>
  </div>
  <div class="dropdown">
    <button class="dropbtn  bg-transparent"><i style="vertical-align: text-top;" class="ri-map-pin-line"></i>India <i style="vertical-align: middle;" class="ri-arrow-drop-down-line"></i></button>
    <div class="dropdown-content">
      <a href="https://abglobalmining.co.za/" target="_blank" ><h6> South Africa</h6></a>
